...
{
    public const float PhaseDuration = 300f;
    public const int TotalTasks = 10;
    public const float TaskSpawnInterval = 30f;
    public const int PointsPerTask = 100;
    public const int TasksToWin = 5;
